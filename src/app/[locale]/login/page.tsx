...
export default function Login() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-start justify-center pt-8 p-4 pb-32 overflow-y-auto scrollbar-hide">
      <div className="w-full max-w-sm mx-auto">
        <div className="bg-white/80 backdrop-blur-sm shadow-2xl rounded-2xl p-6 border border-white/20 max-h-[90vh] overflow-y-auto scrollbar-hide">
